...
export const postTodo = async (req, res, next) => {
  ...
  try {
    ...
    res.status(201).json({ message: "Todo added successfully", payload: insertTodo });
  } catch (error) {
...
export const updateTodo = async (req, res, next) => {
  ...
  try {
    ...
    res.status(200).json({ message: "Todo updated successfully", payload: todo });
  } catch(error) {
    res.status(500).json({ message: error.message });
  }
}
...
export const deleteTodo = async (req, res, next) => {
  ...
  try {
    ...
    res.status(200).json({ message: "Todo deleted successfully", payload: todo });
  } catch(error) {
    res.status(500).json({ message: error.message });
  }
}